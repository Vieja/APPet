...
class PetAdapter(val context: Context, var dataSource: List<Pet>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        val id = context.resources.getIdentifier(dataSource.get(position).category, "drawable", context.packageName)
