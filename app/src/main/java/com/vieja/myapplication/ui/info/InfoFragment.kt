...
class InfoFragment : Fragment() {
    ...
    fun presentPet(root: View) {
        ...
        if (pet.sex != null) {
            ...
            (root.findViewById<TextInputEditText>(R.id.info_text_sex) as TextView).text = pet.getLocalPetSex(requireContext())
        } else {
        ...
        if (pet.death != Date(0)) {
            (root.findViewById<TextInputEditText>(R.id.info_text_death) as TextView).text = formattedDateAsLongMonth.format(pet.death)
        } else {
